...
class Daily:
    def __init__(self,root):
        ...
        lbl_expense_name=Label(Manage_Frame, text="Expense Name:",bg="crimson",fg="white", font=("monospace",20,"bold"))
        lbl_expense_name.grid(row=1,column=0,pady=10,padx=20,sticky="w")

        txt_expense_name=Entry(Manage_Frame,textvariable=self.expense_name,font=("monospace",10,"bold"),bd=5,relief=GROOVE)
        txt_expense_name.grid(row=1,column=1,pady=10,padx=8,sticky="w")

        lbl_expense_cost=Label(Manage_Frame, text="Expense Cost:",bg="crimson",fg="white", font=("monospace",20,"bold"))
        lbl_expense_cost.grid(row=2,column=0,pady=10,padx=20,sticky="w")

        txt_expense_cost=Entry(Manage_Frame,textvariable=self.expense_cost,font=("monospace",10,"bold"),bd=5,relief=GROOVE)
        ...
        Addbtn=Button(btn_Frame,command=self.add_expense,text="Add",width=5).grid(row=0,column=0,padx=8,pady=10)
        ...
        lbl_Search=Label(Detail_Frame,text="Pick Date: ",bg="crimson",fg="white",font=("monospace",20,"bold"))
        ...
        showallbtn=Button(Detail_Frame,command=self.fetch_date,text="Fetch",width=10,pady=5).grid(row=0,column=4,padx=10,pady=10)
