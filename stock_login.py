...
class login_system:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Login System",font=("monospace",40,"bold"),bg="yellow",fg="red",bd=10,relief=GROOVE)
        ...
        lbluser=Label(Login_Frame,text=" Username",image=self.user_icon,compound=LEFT,font=("monospace",20,"bold"),bg="white").grid(row=1,column=0,padx=20)
        txtuser=Entry(Login_Frame,textvariable=self.uname,bd=5,relief=GROOVE,font=("",15)).grid(row=1,column=1,padx=20)

        lblpass=Label(Login_Frame,text=" Password",image=self.pass_icon,compound=LEFT,font=("monospace",20,"bold"),bg="white").grid(row=2,column=0,padx=20)
        txtpass=Entry(Login_Frame,show="*",textvariable=self.pass_,bd=5,relief=GROOVE,font=("",15)).grid(row=2,column=1,padx=20)

        btn_log=Button(Login_Frame,command=self.login,text="Login",width=15,font=("monospace",14,"bold"),bg="yellow",fg="red").grid(row=3,column=1,pady=10)
